...
class NewsModule(BaseModule):
    domain_name = "news"
    router_module = "app.news.router"
    scheduler_module = "app.news.scheduler"
    ...
    def register(cls, ctx: AppContext) -> None:
        ...
        sources_mod = importlib.import_module("app.news.sources_router")
        news_mod = importlib.import_module("app.news.router")
